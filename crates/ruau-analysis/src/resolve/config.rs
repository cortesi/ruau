...
impl AnalysisConfig {
    ...
    #[must_use]
    pub const fn mode(&self) -> Option<AnalysisMode> {
        self.mode
    }
...
impl Resolver for EmptyResolver {
    fn config_for_module(&self, _name: &ModuleName) -> ResolverResult<AnalysisConfig> {
...
pub struct InMemoryResolver {
    ...
    configs: BTreeMap<ModuleName, AnalysisConfig>,
...
impl InMemoryResolver {
    ...
    pub fn set_default(&mut self, config: AnalysisConfig) {
        self.default = config;
    }

    /// Sets config for a module.
    pub fn insert(&mut self, name: impl Into<ModuleName>, config: AnalysisConfig) {
